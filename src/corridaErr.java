...
public class corridaErr {
    ...
    public static void main(String[] args) {
        ...
        int vec[] = new int[4];
        try{
            val1 = Integer.parseInt(JOptionPane.showInputDialog("Digite un número"));
            
            val2 = Integer.parseInt(JOptionPane.showInputDialog("Digite otro número"));
            ...
            JOptionPane.showMessageDialog(null, "Error: Accediendo al vector en la posición " + ex.getMessage());
        }finally{
